                        ...
                        <div className="row">
                            <div className="col-lg-3 col-md-6">
                                <div className="footer-box mb-md-40">
                                    <div className="footer_logo mb-4"> <Link to="/"> <img  loading="lazy" src={process.env.PUBLIC_URL + "/assets/images/logo5f.webp"} className="img-fluid" alt="logo" style={{ Maxwidth: "195px", height: "55px" }} /> </Link> </div>
                            ...
                            <div className="col-lg-3 col-md-6">
                                <div className="footer-box mb-sm-40">
                                    ...
                                    <div className="newsletter">
                                        ...
                                        <p className="text-custom-white"><Link  className="no_pop" to="used-car-in-bangalore">Bangalore </Link> | <Link  className="no_pop" to="used-car-in-hyderabad">Hyderabad </Link> | <Link  className="no_pop" to="used-car-in-ahmedabad">Ahmedabad </Link> | <Link  className="no_pop" to="used-car-in-surat">Surat </Link> | <Link  className="no_pop" to="used-car-in-pune">Pune </Link> | <Link  className="no_pop" to="used-car-in-jaipur">Jaipur </Link> | <Link  className="no_pop" to="used-car-in-lucknow">Lucknow </Link> | <Link  className="no_pop" to="used-car-in-kanpur">Kanpur </Link> | <Link  className="no_pop" to="used-car-in-nagpur">Nagpur </Link> | <Link  className="no_pop" to="used-car-in-indore">Indore </Link> | <Link  className="no_pop" to="used-car-in-thane">Thane </Link> </p> 
                                    </div>   
